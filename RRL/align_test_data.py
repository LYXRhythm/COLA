...
if __name__ == "__main__":
    if args.dataset == 'office_home':
        ...
        if tt == 'a':
            ...
            t = 'sketch'
             ...
             raise NotImplementedError
    output_path = './data_press/{}/{}/{}_test1.txt'.format(args.dataset,args.dset,t)
    if not os.path.exists(output_path):
        open(output_path, 'w').close()
    flabels,flen = get_labels(pth='{}/{}_test.txt'.format(args.dataset,s))
    #print(flabels,flen)
    slabels,slen = get_labels(pth='{}/{}_test.txt'.format(args.dataset,t))
    ...
    for i in range(flen):
        ...
        with open('./data_press/{}/{}_test.txt'.format(args.dataset,t), 'r', encoding='utf-8') as file2:
